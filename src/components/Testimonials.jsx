    ...
    <section className='bg-testimonial-section'>
      <div className='py-[100px] px-[1.5rem] mx-auto max-w-[1320px]'>
        <div className='flex items-center' id='testimonial-div-header'>
          <div>
            <h2 className='text-[#060340] font-[600] text-[1.7rem]' id='testimonial-h'>
              Testimonials
          </h2>
        ...
        >
          ...
          {Testimonials.map(({ testifier, testimony, testifier_img, rating }, i) => (
            <SwiperSlide key={i}>
              <TestimonialCard testifier={testifier} testimony={testimony} testifierImg={testifier_img} rating={rating} />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
